<div class="containerPerfilBlack">
  <div class="perfilBlack">
    <h1>Username</h1>
      <div class="divFoto">
      ...
      <br>
      <input type="button" value="Actualizar foto" class="actualizarFotoBlack">
  </div>
  <div class="listaDatosBlack">
    <h2>Datos de usuario</h2>
    <table class="estiloTablaBlack">
      <tr>
        <th>Nombre:</th>
        <td>Example</td>
        <td></td>

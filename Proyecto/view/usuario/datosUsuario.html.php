<div class="containerPerfil">
    ...
    <div class="perfil">
        ...
        <div class="divFoto">
        <img class="sinFoto" src="<?php echo isset($usuario->foto_perfil) ? $usuario->foto_perfil : 'https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_960_720.png'; ?>" alt="Foto de perfil default">
        </div>
    ...
    <div class="listaDatos">
        ...
        <form action="index.php?controller=usuario&action=update" method="post" id="datosUsuarioForm">
            <table class="estiloTabla">
                ...
                <tr>
                    <th>Foto de perfil URL:</th>
                    <td><input type="text" name="nuevaFoto" id="nuevaFoto" value="" readonly ></td>
                    <td>
                        <button id="editarFoto">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16" color="#4DBAD9">
                        <path d="M15.502 1.94a.5.5 0 0 1 0 .706L14.459 3.69l-2-2L13.502.646a.5.5 0 0 1 .707 0l1.293 1.293zm-1.75 2.456-2-2L4.939 9.21a.5.5 0 0 0-.121.196l-.805 2.414a.25.25 0 0 0 .316.316l2.414-.805a.5.5 0 0 0 .196-.12l6.813-6.814z"/>
                        <path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5z"/></svg><path d="..."></path></svg>
                        </button>
                ...
                <tr>
                    ...
                    <td><input type="text" name="actualPassword" id="actualPassword" value=""></td>
                </tr>
                <tr>
...
document.getElementById('editarFoto').addEventListener('click', function(e) {
    e.preventDefault();
    document.getElementById("nuevaFoto").readOnly = false;
});
</script>
